...
Rails.application.config.sorcery.submodules = [:external, :activity_logging, :http_basic_auth, :remember_me, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.scope = "public_profile, email" #etc
